...
public interface ParentComponent {
   ...
   *   このAbstract factory methodの引数としてそれを指定する必要がある(Magic code)
   *
   *   ParentComponentがChildComponentの要求するModuleを知っているのは
   *   余計な結合を生む. この辺を解消する@Component.BuilderがAPI 2.1から生えている.
   */
